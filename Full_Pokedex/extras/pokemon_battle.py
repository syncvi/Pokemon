...
class Pokemon(pygame.sprite.Sprite):
    ...
    def draw_hp(self):
        ...
        # display "HP" text
        font = pygame.font.SysFont("Arcade Normal", 16)
        text = font.render(
            f'HP: {self.current_hp} / {self.max_hp}', True, white)
...
def display_message(message):
    ...
    pygame.draw.rect(game, dark_grey, (10, 350, 480, 140))
    pygame.draw.rect(game, black, (10, 350, 480, 140), 3)

    # display the message
    font = pygame.font.SysFont("Arcade Normal", 14)
...
def create_button(width, height, left, top, text_cx, text_cy, label):
    ...
    if button.collidepoint(mouse_cursor):
        ...
        pygame.draw.rect(game, dark_grey, button)
...
def initialize_battle():
    ...
    size = (game_width, game_height)
    game = pygame.display.set_mode(size)
    bg = pygame.image.load('assets/bgg.gif').convert()
    ic = pygame.image.load('assets/Pokeball2.png')
    ...
    level = 30
    bulbasaur = Pokemon('Venusaur', level, 25, 150)
    charmander = Pokemon('Charizard', level, 175, 150)
    squirtle = Pokemon('Blastoise', level, 325, 150)
    ...
    while game_status != 'quit':
        ...
        if game_status == 'player turn':
            ...
            fight_button = create_button(240, 140, 10, 350, 130, 412, 'ATK')
            potion_button = create_button(
                240, 140, 250, 350, 370, 412, f'PTN [{player_pokemon.num_potions}]')
        ...
        if game_status == 'player move':
            ...
            for i in range(len(player_pokemon.moves)):
                ...
                button = create_button(button_width, button_height, left,
                                       top, text_center_x, text_center_y, move.name.capitalize())
